...
export default async (
    ...
    try {
        ...
        const response = await changeFunctionWithAttachment(rq.account_id, rq.privatekey, APP_CONTRACT, "marketplace_buy", { token_id: rq.token_id, owner: pet_info.pet_data.owner, buyer: rq.account_id, price: pet_info.price }, new BN('1'), "https://pd-testnet.marmaj.org/callback?page=pet_bought", new BN('150000000000000'));
